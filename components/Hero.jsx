...
//   return (
//     <section className="bg-white h-auto mt-[180px] w-full flex flex-col md:flex-row px-4 md:px-8">
//       <div className="mt-12 md:mt-36 md:flex-1">
//         <HeroCard />
//         <HeroStat />
//       </div>
//       <div className="flex-1 text-center mt-8 md:mt-0 md:max-w-[788px] mx-auto">
